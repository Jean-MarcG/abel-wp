...
<![endif]-->
  ...
  <header class="header" id="header">
    <nav class="nav">
      <a href="/accueil/" class="nav__logo">
      ...
      <div class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          ...
          <li class="nav__item nav__dropdown">
            <a href="/le-permis-automobile-avec-lauto-ecole-abel/" class="nav__link">Permis de conduire</a>
            <ul class="nav__dropdown-content">
              <li><a href="#">Permis B</a></li>
              <li><a href="#">Permis B AAC</a></li>
            </ul>
          </li>
          <li class="nav__item">
      ...
      <div class="nav__cta">
        <a href="/contact/" class="cta cta--yellow">Nous contacter</a>
      </div>

      <!--       <div class="nav__social">
        <a href="https://www.instagram.com/auto_ecole_abel/" target="_blank" class="nav__social-link instagram">
