      ...
      <ul>
        <li class="contact__card">
          <a href=" tel:+33326360536">
            <span>Abel Hauts de Murigny</span>
            <span>03.26.36.05.36</span>
            <span class="cta">J'appelle</span>
          </a>
        </li>
        <li class="contact__card">
          <a href=" tel:+33326404533">
            <span>Abel Courlancy</span>
            <span>03.26.40.45.33</span>
            <span class="cta">J'appelle</span>
          </a>
        </li>
        <li class="contact__card">
          <a href=" tel:+0326252565">
            <span>Abel Venise</span>
            <span>03.26.25.25.65</span>
            <span class="cta">J'appelle</span>
          </a>
        </li>
        <li class="contact__card">
          <a href=" tel:+33326362323">
            <span>Abel Taissy</span>
            <span>03.26.36.23.23</span>
            <span class="cta">J'appelle</span>
          </a>
        </li>
      </ul>
