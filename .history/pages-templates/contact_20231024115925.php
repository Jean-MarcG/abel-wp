...
<section class="contact">
  <div class="contact__left">
    <div>
      ...
      <ul>
        <li><a href="http://localhost:10038/#agences">Abel Hauts de Murigny</a></li>
        <li><a href="http://localhost:10038/#agences">Abel Courlancy</a></li>
        <li><a href="http://localhost:10038/#agences">Abel Venise</a></li>
        <li><a href="http://localhost:10038/#agences">Abel Taissy</a></li>
      </ul>
      <p>03.26.36.23.23</p>
      <button id="copyEmail">info@autoecoleabel.fr<svg width=" 17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="contact__right">
    ...
    <small>
      * En soumettant ce formulaire, j'accepte que les informations saisies soient exploitées dans le cadre de votre demande d'information et de la relation commerciale qui peut en découler.<br>
      Pour retirer votre consentement à l'utilisation des données collectées par ce formulaire, veuillez nous envoyer un mail à contact@cs-conseil-ec.com
    </small>
  </div>
</section>
