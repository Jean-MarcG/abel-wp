...
copyEmail.addEventListener("click", function (Event) {
    navigator.clipboard.writeText("info@autoecoleabel.fr").then(() => {
        document.querySelector('.Contact__left button').innerHTML = 'info@autoecoleabel.fr <svg width="22" height="17" viewBox="0 0 22 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 7.95349L8.02326 13.9767L20.5 1.5" stroke="#EBE8E3" stroke-width="3"/></svg>';
    })
});
