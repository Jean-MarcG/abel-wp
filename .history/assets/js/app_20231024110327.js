...
sr.reveal('.hero__container, .formation__container, .package__title, .package__subtitle, .forward__container, .agences__title', {origin: 'bottom'})
sr.reveal('.package__card--left', {origin: 'left'})
sr.reveal('.package__card--right', {origin: 'right'})
